      ...
      <div className="flex flex-col gap-3">
        ...
        >
          ...
          <motion.div
            ...
            transition={{ delay: 1 }}
          >
            <span className="text-3xl font-black text-white"><Counter target={resolved} />/{total}</span>
            <span className="text-sm text-neutral-400 block">Items Resolved</span>
          </motion.div>
        </motion.div>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          >
            ...
            <span className="text-base font-bold text-white block"><Counter target={8} /></span>
            <span className="text-xs text-neutral-400">Negatives Removed</span>
          </motion.div>
          <motion.div
            className="rounded-lg bg-white/5 border border-white/10 p-2.5 text-center"
            initial={{ opacity: 0, y: 10 }}
          ...
          >
            ...
            <span className="text-base font-bold text-white block"><Counter target={4} /></span>
            <span className="text-xs text-neutral-400">Disputes Won</span>
          </motion.div>
        </div>
      </div>
