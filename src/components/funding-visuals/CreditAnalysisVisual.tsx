    ...
    <div className="w-full h-full grid grid-cols-1 md:grid-cols-3 gap-3 relative">
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          ...
          <span className="text-[10px] uppercase tracking-widest text-neutral-500 mb-1 relative z-10">Current Score</span>
          <span className="text-5xl font-black text-emerald-400 drop-shadow-[0_0_24px_rgba(16,185,129,0.5)] relative z-10">
            <Counter target={720} />
          </span>
          <span className="text-[10px] text-neutral-500 mt-1 relative z-10">+42 pts improvement</span>
        ...
        <div className="flex flex-col gap-2">
          {bureaus.map((b, i) => (
            ...
            >
              <div>
                <span className="text-[10px] text-neutral-500 block">{b.name}</span>
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          ...
          <span className="text-[10px] uppercase tracking-widest text-neutral-500 mb-2 relative z-10">Score History</span>
        ...
        <div className="grid grid-cols-3 gap-2">
          {([
            ...
            >
              <span className="text-[9px] text-neutral-500 block">{s.label}</span>
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          <span className="text-[10px] uppercase tracking-widest text-neutral-500 mb-3">Negative Items</span>
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            >
              3<span className="text-neutral-500 text-sm font-normal">/5</span>
            </motion.span>
