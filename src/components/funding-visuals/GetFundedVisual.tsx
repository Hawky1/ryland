...
export default function GetFundedVisual() {
  return (
    <div className="w-full h-full grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div className="space-y-2">
          {fundingBreakdown.map((f, i) => (
            ...
            >
              ...
              <span className="text-sm font-bold text-cyan-400">$<Counter target={f.amount} /></span>
            </motion.div>
          ))}
        </div>
      </div>
      ...
      >
        <span className="text-[10px] uppercase tracking-widest text-neutral-500 mb-3">Milestones Complete</span>
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          >
            5<span className="text-neutral-500 text-sm font-normal">/5</span>
          </motion.span>
          <span className="text-[10px] text-emerald-400">All Complete</span>
          <motion.div
          ...
          {checklist.map((item, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <span className="text-xs text-neutral-200 font-medium block">{item.label}</span>
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          <span className="text-xs font-bold text-white">🎉 Funding Complete</span>
          <span className="text-[9px] text-neutral-400 block mt-0.5">Average timeline: 45 days</span>
        </motion.div>
      </div>
    </div>
  );
