        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-9 h-9 rounded-lg bg-slate-100 border border-slate-200 text-slate-500 hover:bg-slate-200 hover:text-slate-900 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-9 h-9 rounded-lg bg-slate-100 border border-slate-200 text-slate-500 hover:bg-slate-200 hover:text-slate-900 transition-colors">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-9 h-9 rounded-lg bg-slate-100 border border-slate-200 text-slate-500 hover:bg-slate-200 hover:text-slate-900 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/#services" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">Business Funding</Link></li>
              <li><Link to="/#services" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">Credit Restoration</Link></li>
              <li><Link to="/#services" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">Private Community</Link></li>
              <li><Link to="/store" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">Digital Products</Link></li>
              <li><Link to="/#services" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">1-on-1 Consultation</Link></li>
            </ul>
          </div>
