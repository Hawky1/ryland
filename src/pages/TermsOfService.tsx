  ...
  return (
    <div className="min-h-screen selection:bg-blue-500/30 selection:text-white antialiased text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-10 font-['Manrope']">Terms of Service</h1>
        ...
        <div className="space-y-10 text-slate-300 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-3 space-y-2">
              <li><strong className="text-white">Funding Referrals:</strong> We connect business owners with lending partners and funding sources. Ryland Partners acts as a referral service and is not a direct lender.</li>
              <li><strong className="text-white">Credit Restoration:</strong> We offer credit restoration and credit education services to help individuals improve their credit profiles. Results vary by individual.</li>
              <li><strong className="text-white">Partner/Affiliate Program:</strong> We offer a referral-based partner program where approved partners can earn commissions by referring qualified business owners to our funding services.</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-4">6. Telemarketing Sales Rule (TSR) Compliance</h2>
            ...
            <p className="mt-3">For full TSR disclosures, please visit our <Link to="/tsr-compliance" className="text-blue-400 hover:text-blue-300 underline">TSR Compliance page</Link>.</p>
          </section>
      ...
      <footer className="border-t border-white/10 py-8 mt-16">
        <div className="max-w-4xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link to="/disclaimers" className="text-sm text-slate-400 hover:text-white transition-colors">Disclaimers</Link>
          </div>
        </div>
      </footer>
    </div>
