    ...
    <div className="min-h-screen selection:bg-blue-500/30 selection:text-white antialiased text-slate-900">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .shiny-cta {
          ...
          box-shadow: inset 0 1px 0 0 rgba(255,255,255,0.16), 0 1px 2px rgba(0,0,0,0.72), 0 2px 4px rgba(0,14,36,0.32), 0 var(--shadow-size) 16px rgba(0,14,36,0.2);
        ...
        .shiny-cta::before {
          ...
          background:conic-gradient(from calc(var(--gradient-angle) + var(--gradient-angle-offset)),transparent,var(--gradient-shine),transparent 30%);
