      ...
      <section className="max-w-7xl mx-auto pt-16 pb-36 px-8 lg:px-20 relative">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="text-center lg:text-left lg:flex-1 max-w-3xl">
            <h1 className="text-[36px] leading-[1] sm:text-5xl lg:text-[56px] font-medium text-zinc-100 tracking-tighter font-geist text-left mt-20" style={{ maskImage: 'linear-gradient(290deg, transparent, black 0%, black 40%, transparent)', WebkitMaskImage: 'linear-gradient(290deg, transparent, black 0%, black 40%, transparent)' }}>Fund and build your dream business.</h1>
