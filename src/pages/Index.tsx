          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="group relative overflow-hidden transition-all duration-500 hover:border-blue-500/30 hover:ring-blue-500/20 bg-gradient-to-br from-neutral-900/80 to-neutral-950/90 border-white/10 border ring-white/5 ring-1 rounded-2xl">
              ...
              <div className="p-6 relative z-10">
                ...
                <div className="inline-flex mb-4 text-blue-400 bg-blue-500/10 w-12 h-12 ring-blue-500/20 ring-1 rounded-xl items-center justify-center">
                ...
                <h3 className="text-xl font-semibold tracking-tight text-neutral-100 mb-2">Business Funding</h3>
                ...
                <a href="#cta" className="inline-flex items-center gap-1.5 text-sm font-medium text-blue-400 hover:text-blue-300 transition-colors">
                  Learn more <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
                </a>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden transition-all duration-500 hover:border-indigo-500/30 hover:ring-indigo-500/20 bg-gradient-to-br from-neutral-900/80 to-neutral-950/90 border-white/10 border ring-white/5 ring-1 rounded-2xl">
              ...
              <div className="p-6 relative z-10">
                ...
                <div className="inline-flex mb-4 text-indigo-400 bg-indigo-500/10 w-12 h-12 ring-indigo-500/20 ring-1 rounded-xl items-center justify-center">
                ...
                <h3 className="text-xl font-semibold tracking-tight text-neutral-100 mb-2">Credit Restoration</h3>
                ...
                <a href="#cta" className="inline-flex items-center gap-1.5 text-sm font-medium text-indigo-400 hover:text-indigo-300 transition-colors">
                  Learn more <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
                </a>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden transition-all duration-500 hover:border-emerald-500/30 hover:ring-emerald-500/20 bg-gradient-to-br from-neutral-900/80 to-neutral-950/90 border-white/10 border ring-white/5 ring-1 rounded-2xl">
              ...
              <div className="p-6 relative z-10">
                ...
                <div className="inline-flex mb-4 text-emerald-400 bg-emerald-500/10 w-12 h-12 ring-emerald-500/20 ring-1 rounded-xl items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6"><path d="M3 3v18h18"></path><path d="m19 9-5 5-4-4-3 3"></path></svg>
                </div>
                <h3 className="text-xl font-semibold tracking-tight text-neutral-100 mb-2">Credit Building</h3>
                <p className="leading-relaxed text-sm text-neutral-400 mb-6">Strategic tradeline placement and credit optimization to build a fundable profile from scratch in 30–60 days.</p>
                <a href="#cta" className="inline-flex items-center gap-1.5 text-sm font-medium text-emerald-400 hover:text-emerald-300 transition-colors">
                  Learn more <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
                </a>
              </div>
            </div>

            {/* Card 4: Join the Community */}
            <div className="group relative overflow-hidden transition-all duration-500 hover:border-amber-500/30 hover:ring-amber-500/20 bg-gradient-to-br from-neutral-900/80 to-neutral-950/90 border-white/10 border ring-white/5 ring-1 rounded-2xl">
              <div className="absolute -bottom-16 -right-16 h-56 w-56 rounded-full bg-gradient-to-tr from-amber-500/30 via-orange-500/20 to-yellow-500/10 blur-3xl transition-all duration-700 group-hover:scale-110"></div>
              <div className="absolute -top-8 -left-8 bg-gradient-to-br from-amber-500/25 via-orange-500/15 to-transparent w-40 h-40 rounded-full blur-2xl"></div>
              <div className="p-6 relative z-10">
                <div className="flex mb-4 items-start">
                  <span className="inline-flex items-center gap-1.5 text-xs font-medium text-white bg-white/5 ring-white/20 ring-1 rounded-lg py-1 px-2.5">
                ...
                <div className="inline-flex mb-4 text-amber-400 bg-amber-500/10 w-12 h-12 ring-amber-500/20 ring-1 rounded-xl items-center justify-center">
                ...
                <h3 className="text-xl font-semibold tracking-tight text-neutral-100 mb-2">Join the Community</h3>
                <p className="leading-relaxed text-sm text-neutral-400 mb-6">Become a partner, access our Skool academy, and learn to build wealth through digital entrepreneurship.</p>
                <a href="#cta" className="inline-flex items-center gap-1.5 text-sm font-medium text-amber-400 hover:text-amber-300 transition-colors">
                  Get started <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
                </a>
              </div>
            </div>
