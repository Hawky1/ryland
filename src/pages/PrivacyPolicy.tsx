  ...
  return (
    <div className="min-h-screen selection:bg-blue-500/30 selection:text-white antialiased text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-10 font-['Manrope']">Privacy Policy</h1>
        ...
        <div className="space-y-10 text-slate-300 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-3 space-y-2">
              <li><strong className="text-white">Identifiers:</strong> Name, email address, phone number, mailing address</li>
              <li><strong className="text-white">Financial Information:</strong> Business revenue details, credit-related information (provided voluntarily for service purposes)</li>
              <li><strong className="text-white">Commercial Information:</strong> Records of services requested, purchasing history</li>
              <li><strong className="text-white">Internet Activity:</strong> Browsing history on our site, search history, interaction with our website</li>
              <li><strong className="text-white">Professional Information:</strong> Business name, industry, role/title</li>
            </ul>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-3 space-y-2">
              <li><strong className="text-white">Funding Partners & Lenders:</strong> To process your funding application or referral</li>
              <li><strong className="text-white">Service Providers:</strong> Companies that assist us in operating our website, conducting business, or servicing you (e.g., CRM, email marketing, analytics)</li>
              <li><strong className="text-white">Credit Bureaus & Credit Service Partners:</strong> In connection with credit restoration services</li>
              <li><strong className="text-white">Legal Authorities:</strong> When required by law, regulation, or legal process</li>
            </ul>
            <p className="mt-3">We do not sell your personal information for monetary consideration. See our <Link to="/ccpa" className="text-blue-400 hover:text-blue-300 underline">CCPA Notice</Link> for more details on your rights.</p>
          </section>

          <div className="border-t border-white/10" />

          <section>
            <h2 className="text-xl font-semibold text-white mb-4">5. Your Rights Under the CCPA</h2>
            ...
            <ul className="list-disc pl-6 mt-3 space-y-2">
              ...
              <li><strong className="text-white">Right to Delete:</strong> You may request that we delete the personal information we have collected from you, subject to certain exceptions.</li>
              <li><strong className="text-white">Right to Opt-Out:</strong> You may opt out of the "sale" or "sharing" of your personal information.</li>
            ...
            <p className="mt-3">To exercise your rights, please visit our <Link to="/ccpa" className="text-blue-400 hover:text-blue-300 underline">CCPA Rights page</Link> or contact us at privacy@rylandpartners.com.</p>
          </section>

          <div className="border-t border-white/10" />

          <section>
            <h2 className="text-xl font-semibold text-white mb-4">6. Cookies & Tracking Technologies</h2>
            <p>We use cookies and similar tracking technologies to collect information about your browsing activity. For detailed information about the cookies we use and how to manage your preferences, please visit our <Link to="/cookie-policy" className="text-blue-400 hover:text-blue-300 underline">Cookie Policy</Link>.</p>
          </section>
      ...
      <footer className="border-t border-white/10 py-8 mt-16">
        <div className="max-w-4xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link to="/ccpa" className="text-sm text-slate-400 hover:text-white transition-colors">CCPA</Link>
            <Link to="/cookie-policy" className="text-sm text-slate-400 hover:text-white transition-colors">Cookie Policy</Link>
          </div>
        </div>
      </footer>
    </div>
